...
<!-- usage:start -->
> 📈 **사용량** — 최근 14일 조회 **20**회(고유 2) · 클론 **444**회(고유 157) · 릴리스 자산 누적 다운로드 **76**
>
...
`scienceON_search` · `scienceON_export` · `scienceON_collect_groups` 의 `retry_incomplete=0`
으로 끈다 — 대신 결손이 남고 `total_mismatch` 로만 표시된다.
